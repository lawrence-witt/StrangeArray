...
const Stars = ({ count = 1000, xOff = 0, yOff = 0, zOff = 50 }) => {
  ...
  useFrame(() => {
    if (starOpacity < 1) setStarOpacity(starOpacity+0.01)
  });
  ...
  return (
    <points>
      ...
      <pointsMaterial attach="material" size={2} sizeAttenuation color="white" transparent opacity={starOpacity} fog={false} />
    </points>
  )
}
